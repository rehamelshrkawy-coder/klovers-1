  ...
  return (
    <Card className="rounded-2xl border-2 border-yellow-300">
      ...
      <CardContent className="space-y-5">
        ...
        {/* Schedule summary */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm space-y-1 dark:bg-yellow-950/40 dark:border-yellow-800">
        ...
        <div className="space-y-3">
          ...
          {!confirmBulk ? (
            ...
            <div className="flex items-center gap-3 p-3 bg-red-50 border border-red-200 rounded-lg dark:bg-red-950/40 dark:border-red-800">
