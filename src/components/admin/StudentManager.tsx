        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label htmlFor="student-email" className="text-sm font-medium text-foreground">Email * {lookingUpEmail && <Loader2 className="inline h-3 w-3 animate-spin ms-1" />}</label>
