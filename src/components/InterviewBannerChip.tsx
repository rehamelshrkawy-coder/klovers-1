...
const InterviewBannerChip = () => {
  ...
  return (
    <div
      className={`fixed bottom-32 z-40 animate-in slide-in-from-bottom-4 duration-500 ${isAr ? "start-4" : "start-4"}`}
      dir={isAr ? "rtl" : "ltr"}
    >
      <div className="flex items-center gap-2 bg-foreground text-background ps-3 pe-2 py-2 rounded-full shadow-xl border border-primary/30 max-w-[260px]">
        ...
        <Link
          ...
          className="flex-shrink-0 text-primary-text hover:text-primary-text/80 transition-colors"
