...
export default function InstallPrompt() {
  ...
  return (
    <div
      ...
      aria-modal="false"
      className="fixed bottom-20 start-4 end-4 md:left-auto md:end-6 md:w-80 z-[200] bg-card border border-border rounded-xl shadow-xl p-4 flex items-start gap-3 animate-in slide-in-from-bottom-4 duration-300"
    >
